...
namespace DataModels
{
	...
	public partial class ReviewHogMainDB : LinqToDB.Data.DataConnection
	{
		...
		public ReviewHogMainDB(DataOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public ReviewHogMainDB(DataOptions<ReviewHogMainDB> options)
	...
	public partial class ProductDetail
	{
		...
		[Column("star_rating_score"),     Nullable         ] public decimal? StarRatingScore  { get; set; } // numeric(18, 0)
		[Column("total_star_ratings"),    Nullable         ] public decimal? TotalStarRatings { get; set; } // numeric(18, 0)

		#region Associations

		/// <summary>
		/// FK_product_review_product_detail_BackReference (dbo.product_review)
		/// </summary>
		...
		/// <summary>
		/// FK_review_sentimental_product_detail_BackReference (dbo.review_sentimental)
		/// </summary>
		[Association(ThisKey="Id", OtherKey="ProductId", CanBeNull=true)]
	...
	public partial class ProductReview
	{
		...
		/// <summary>
		/// FK_product_review_product_detail (dbo.product_detail)
		/// </summary>
	...
	public partial class ReviewSentimental
	{
		...
		/// <summary>
		/// FK_review_sentimental_product_detail (dbo.product_detail)
		/// </summary>
		[Association(ThisKey="ProductId", OtherKey="Id", CanBeNull=true)]
		public ProductDetail Product { get; set; }
